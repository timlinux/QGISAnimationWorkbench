...
class Ui_animation_workbench_base(object):
    def setupUi(self, animation_workbench_base):
        ...
        animation_workbench_base.resize(617, 779)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 601, 721))
        ...
        self.gridLayout_2.addWidget(self.pan_easing_combo, 0, 1, 1, 1)
        ...
        self.zoom_easing_preview = QtWidgets.QWidget(self.frame)
        self.zoom_easing_preview.setMinimumSize(QtCore.QSize(0, 150))
        self.zoom_easing_preview.setObjectName("zoom_easing_preview")
        self.gridLayout_3.addWidget(self.zoom_easing_preview, 3, 0, 1, 1)
        self.pan_easing_preview_label = QtWidgets.QLabel(self.frame)
        ...
        self.zoom_easing_label_3 = QtWidgets.QLabel(self.frame)
        self.zoom_easing_label_3.setObjectName("zoom_easing_label_3")
        self.gridLayout_3.addWidget(self.zoom_easing_label_3, 4, 0, 1, 1)
        self.pan_easing_preview = QtWidgets.QWidget(self.frame)
        self.pan_easing_preview.setMinimumSize(QtCore.QSize(0, 150))
        self.pan_easing_preview.setObjectName("pan_easing_preview")
        self.gridLayout_3.addWidget(self.pan_easing_preview, 1, 0, 1, 1)
        self.current_frame_preview = QtWidgets.QWidget(self.frame)
        self.current_frame_preview.setMinimumSize(QtCore.QSize(0, 150))
        ...
        self.zoom_easing_preview_label = QtWidgets.QLabel(self.frame)
        ...
        self.gridLayout_7.addWidget(self.frame, 0, 1, 6, 1)
